...
import best.solitair.solitaire.ui.about.AboutActivity;
...
import static best.solitair.solitaire.helper.Preferences.DEFAULT_CURRENT_GAME;
...
//        setContentView(R.layout.start_layout);
    ...
    private void loadGameList() {
        ...
        for (int i = 14; i < lg.getGameCount()-1; i++) {
        ...
        Button solitairBtn = (Button) findViewById(R.id.solitair_btn);
        solitairBtn.setOnClickListener(new View.OnClickListener() {
            @Override
